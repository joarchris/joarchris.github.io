...
var seq__1639_1643 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1640_1644 = null;
var count__1641_1645 = (0);
var i__1642_1646 = (0);
while(true){
if((i__1642_1646 < count__1641_1645)){
var str_1647 = cljs.core._nth.call(null,chunk__1640_1644,i__1642_1646);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1647})));


var G__1648 = seq__1639_1643;
var G__1649 = chunk__1640_1644;
var G__1650 = count__1641_1645;
var G__1651 = (i__1642_1646 + (1));
seq__1639_1643 = G__1648;
chunk__1640_1644 = G__1649;
count__1641_1645 = G__1650;
i__1642_1646 = G__1651;
continue;
} else {
var temp__5735__auto___1652 = cljs.core.seq.call(null,seq__1639_1643);
if(temp__5735__auto___1652){
var seq__1639_1653__$1 = temp__5735__auto___1652;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1639_1653__$1)){
var c__4609__auto___1654 = cljs.core.chunk_first.call(null,seq__1639_1653__$1);
var G__1655 = cljs.core.chunk_rest.call(null,seq__1639_1653__$1);
var G__1656 = c__4609__auto___1654;
var G__1657 = cljs.core.count.call(null,c__4609__auto___1654);
var G__1658 = (0);
seq__1639_1643 = G__1655;
chunk__1640_1644 = G__1656;
count__1641_1645 = G__1657;
i__1642_1646 = G__1658;
continue;
} else {
var str_1659 = cljs.core.first.call(null,seq__1639_1653__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1659})));


var G__1660 = cljs.core.next.call(null,seq__1639_1653__$1);
var G__1661 = null;
var G__1662 = (0);
var G__1663 = (0);
seq__1639_1643 = G__1660;
chunk__1640_1644 = G__1661;
count__1641_1645 = G__1662;
i__1642_1646 = G__1663;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1668 = script;
goog.object.set(G__1668,"type","text/javascript");

goog.object.set(G__1668,"onload",onload);

goog.object.set(G__1668,"onreadystatechange",onload);

return G__1668;
})();
if((opt_sourceText == null)){
var G__1669 = script__$1;
goog.object.set(G__1669,"src",src);

return G__1669;
} else {
var G__1670 = script__$1;
goog.dom.setTextContent(G__1670,opt_sourceText);
...
var path_1671 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_1671);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1671)].join(''));
} else {
var path_1672 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1672);

goog.object.remove(goog.dependencies_.written,path_1672);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1672)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1673 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1674 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1674);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1673);
}})()})));
}));
